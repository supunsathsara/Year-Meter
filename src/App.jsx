...
function App() {
  ...
  return (
    <div className="bg-[#030014] h-screen w-full flex flex-col justify-center">
      ...
      <div className="flex flex-col my-5 justify-center items-center gap-2">
        <p className="text-white text-2xl">We are {progress.toFixed(2)}% through
        ...
        <p className="text-white text-xl">Today is {format(new Date(), 'MMMM d, yyyy')}</p>
        <p className="text-white text-xl">We have passed {Math.floor(progress * 0.01 * 365)} days, and there are approximately {Math.ceil((100 - progress) * 0.01 * 365)} days left in the current year.</p>
      </div>
      <footer className='absolute bottom-0 w-full py-5'>
